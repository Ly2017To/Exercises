...
void Camera::setCameraParams(const std::string& name, bool enable, const std::string& telegraphic,int aeiStation, const std::string& type,int code, int path, const std::string& ip, int port, const std::string& username, const std::string& password, const std::string& folder) {
    // Setting the camera configuration parameters
    this->name = name;
    this->enable = enable;
    this->telegraphic = telegraphic;
    this->aeiStation = aeiStation;
    this->type = type;
    this->code = code;
    this->path = path;
    this->ip = ip;
